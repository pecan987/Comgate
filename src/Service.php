...
class Service
{
	 ...
	 * @throws \Exception
	 */
    public function createPayment($price, string $refId, $currency = 'CZK', string $methods = "ALL", string $country = 'CZ')
    {
        $payment = new Payment($this);
        $payment->createPayment($price, $refId, $currency, $methods, $country);
